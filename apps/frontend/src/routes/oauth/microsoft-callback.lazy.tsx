...
/**
 * Microsoft OAuth callback component
 * This component handles the callback from Microsoft OAuth authentication
	...
	useEffect(() => {
		...
		const processCallback = async () => {
			try {
				...
				const authData = await handleMicrosoftCallback(sessionId);
